...
const editorialImages = [
  "/3x/Artboard 2@3x.png",
  "/3x/Artboard 2 copy@3x.png",
  "/3x/Artboard 2 copy 2@3x.png",
  "/3x/Artboard 2 copy 3@3x.png",
  "/3x/Artboard 2 copy 4@3x.png",
  "/3x/Artboard 2 copy 5@3x.png",
  "/3x/Artboard 2 copy 6@3x.png",
  "/3x/Artboard 2 copy 7@3x.png",
  "/3x/Artboard 2 copy 8@3x.png",
];
...
export default function EditorialDesignClient() {
  ...
  const otherCaseStudies = caseStudyCards.filter(
    (card) => card.href !== "/editorial-design"
  );
  ...
  return (
    <PasswordGuard title="Editorial Design: Print, Publications & Visual Communication">
      <div
      ...
      >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start w-full">
              ...
              <div className="col-span-1 lg:col-span-8 flex flex-col gap-4 text-left">
                ...
                <h1 className="font-serif text-[38px] sm:text-[52px] md:text-[68px] lg:text-[76px] leading-[1.05] text-primary font-normal tracking-tight">
                  Editorial Design: Print, Publications &amp; Visual Communication
                </h1>
        ...
        {/* FULL-WIDTH CONTINUOUS EDITORIAL IMAGE STACK */}
        <motion.section
          initial="hidden"
          whileInView="visible"
          ...
          <div className="mx-auto w-full px-4 md:px-0 max-w-full md:max-w-[min(88vw,1440px)] flex flex-col gap-6 md:gap-10">
            {editorialImages.map((src, index) => (
              <div key={src} className="w-full">
                <img
                  src={src}
                  alt={`Editorial Design artwork ${index + 1}`}
