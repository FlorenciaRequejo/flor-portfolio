...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="w-full max-w-[850px] mx-auto px-4 md:px-6 pt-6 md:pt-8 pb-6 md:pb-24 flex flex-col items-center justify-center text-center gap-6 relative select-text pointer-events-none"
    >
      <div className="flex flex-col items-center justify-center text-center gap-5 w-full pointer-events-none">
        ...
        <div className="pt-2 pointer-events-auto">
          <Link
            href="/about"
            className="px-7 py-3.5 md:px-8 md:py-4 rounded-full bg-secondary text-background font-sans font-semibold text-[11px] md:text-[12px] uppercase tracking-[1.5px] hover:bg-secondary/90 transition-all duration-200 shadow-md inline-flex items-center gap-2 group cursor-pointer"
          >
            About Me
